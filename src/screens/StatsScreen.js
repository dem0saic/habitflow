      ...
      <ScrollView contentContainerStyle={styles.body} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.aiNudgeCard}>
          ...
          <View style={styles.aiAttribution}>
            <Text style={styles.aiAttributionText}>✦ Generated by Claude Sonnet</Text>
          </View>
        </View>
...
function makeStyles(C) { return {
  ...
  aiAttribution: { marginTop: rs(12), paddingTop: rs(10), borderTopWidth: 1, borderTopColor: C.border },
  aiAttributionText: { fontSize: ms(10), fontFamily: C.med, fontWeight: '500', color: C.textMuted, letterSpacing: ls(10) },
  aiSkeleton: { gap: rs(8) },
